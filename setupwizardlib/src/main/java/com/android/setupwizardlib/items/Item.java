...
public class Item extends AbstractItem {
  ...
  public void onBindView(View view) {
    TextView label = view.findViewById(R.id.suw_items_title);
    label.setText(getTitle());

    TextView summaryView = view.findViewById(R.id.suw_items_summary);
    ...
    if (icon != null) {
      final ImageView iconView = view.findViewById(R.id.suw_items_icon);
